...
- Preparing SST/macro environment ([https://github.com/sstsimulator/sst-macro/blob/master/docs/manual/manual.md](SST/macro's tutorial))
- (not yet) Learn how using a libraries in SMPI look [link](http://simgrid.gforge.inria.fr/simgrid/latest/doc/options.html#options_smpi_privatize_libs)
