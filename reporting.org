...
* Week 1 Jul 2017
** Current work 
  - Follow first week of corsera, corsera class [[https://www.coursera.org/learn/c-plus-plus-a]].  
  ...
  - terminal vt100.
  - Find bug and unclear formulation see the link [[https://simgrid.github.io/SMPI_CourseWare/]].
  fork the space from [[https://github.com/simgrid/SMPI_CourseWare]].
  - Check if it works for simgrid 3.16.
* Further objectives
