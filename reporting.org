...
- Out of office.
* Week 1 Jan 2017
- Analyze CORAL benchmark codes.
* Notes about [[https://asc.llnl.gov/CORAL-benchmarks/][CORAL]] benchmak codes : 
| Benchmark   | reference |Lines of code | parallelism  | Language | Notes     |
|-------------+---------------+--------------+----------+----------+-----------|
| [[https://asc.llnl.gov/CORAL-benchmarks/Skeleton/madness-20131025.tar.gz][MiniMADNESS]] | [[https://asc.llnl.gov/CORAL-benchmarks/Summaries/MADNESS_Summary_v1.pdf][ref]]  | 10,000        | MPI & OPENMP | C++      | depend on OPENMP cannot be useful for us |
| [[https://asc.llnl.gov/CORAL-benchmarks/Skeleton/pynamic-1.3.tar.gz][pynamic]] | [[https://asc.llnl.gov/CORAL-benchmarks/Summaries/Pynamic_Summary_v1.0.pdf][ref]]  | 12,000        | MPI          | python   | code entirely in python contrary to description |
| [[https://asc.llnl.gov/CORAL-benchmarks/Skeleton/HACC_IO.tar.gz][HACCIO]] | [[https://asc.llnl.gov/CORAL-benchmarks/Summaries/HACC_IO_Summary_v1.0.pdf][ref]] | 2,000 | MPI | C++ | work but shows warrnings |
| [[https://asc.llnl.gov/CORAL-benchmarks/Skeleton/ALCF_MPI_Benchmark_v1.02.BGQ.tar.bz2][ALCF MPI Benchmarks]] | [[https://asc.llnl.gov/CORAL-benchmarks/Summaries/ALCF_MPI_Summary_v1.0.pdf][ref]] | 1,000 | MPI | C | Some changes should be done to use mpicc instead of mpixlc_r |
| [[https://asc.llnl.gov/CORAL-benchmarks/Skeleton/IOR.CORAL.1.tar.gz][IOR]] | [[https://asc.llnl.gov/CORAL-benchmarks/Summaries/IOR_Summary_v1.0.pdf][ref]] | 4,000 | MPI | C | Some modification should be applied to get this code work |
| [[https://asc.llnl.gov/CORAL-benchmarks/Datacentric/KMI_HASH_CORAL.tar.gz][KMI_HASH]] | [[https://asc.llnl.gov/CORAL-benchmarks/Summaries/KMI_Summary_v1.1.pdf][ref]] | / | MPI | C | work but shows warnings |
| [[https://asc.llnl.gov/CORAL-benchmarks/Datacentric/BigSort-20130808.tar.bz2][Integer sort]] | [[https://asc.llnl.gov/CORAL-benchmarks/Summaries/BigSort_Summary_v1.1.pdf][integer sort]] | 2,000 | MPI | C | Work but shows warnings |
| [[https://asc.llnl.gov/CORAL-benchmarks/Throughput/namd-src.tar.gz][NAMD]] | [[https://asc.llnl.gov/CORAL-benchmarks/Summaries/NAMD_Summary_v1.0.pdf][ref]] | 180,000 | MPI | C | Some adjustment should be done in order to get it work |
| [[https://asc.llnl.gov/CORAL-benchmarks/Throughput/mcb-20130723.tar.gz][mcb]] | [[https://asc.llnl.gov/CORAL-benchmarks/Summaries/MCB_Summary_v1.1.pdf][ref]] | 13,000 	 | MPI - OPENMP | C | Some adjustment should be done in order to use only MPI |
| [[https://asc.llnl.gov/CORAL-benchmarks/Throughput/amg20130624.tgz][amg2013]] | [[https://asc.llnl.gov/CORAL-benchmarks/Summaries/AMG2013_Summary_v2.3.pdf][ref]] | 75,000 | MPI-OPENMP | C | Work |
| [[https://asc.llnl.gov/CORAL-benchmarks/Throughput/homme1_3_6_mira_2.tgz][CAM-SE]] | [[https://asc.llnl.gov/CORAL-benchmarks/Summaries/CAMSE_Summary_v1.1.pdf][ref]] | 150,000 | MPI, Blas, LAPACK | C, FORTRAN | use Blas and LAPACK |
| [[https://asc.llnl.gov/CORAL-benchmarks/Skeleton/HACC_IO.tar.gz][HACC_IO]] | [[https://asc.llnl.gov/CORAL-benchmarks/Summaries/HACC_IO_Summary_v1.0.pdf][ref]] | 35,000 | MPI | C++ | Work but shows warnings |
| [[https://asc.llnl.gov/CORAL-benchmarks/Science/LSMS_3_rev237.tar.bz2][Lsms]] | [[https://asc.llnl.gov/CORAL-benchmarks/Summaries/LSMS_Summary_v1.1.pdf][ref]] | 200,000 | MPI, Lua, CBLAS | C++ | Depend on cBlasS |
...
| Benchmark   | reference |Lines of code | parallelism  | Language | Notes     |
|-------------+---------------+--------------+----------+----------+-----------|
| [[http://www.nersc.gov/assets/Trinity--NERSC-8-RFP/Benchmarks/Feb22/MiniFE_ref_1.4b.tar][MiniFE]] | [[http://www.nersc.gov/users/computational-systems/cori/nersc-8-procurement/trinity-nersc-8-rfp/nersc-8-trinity-benchmarks/minife/][ref]] | unknown | MPI | C++ | work but but need some adjustments |
| [[http://www.nersc.gov/assets/Trinity--NERSC-8-RFP/Benchmarks/Feb22/MiniGhostv0.9.tar][MiniGhost]] | [[http://www.nersc.gov/users/computational-systems/cori/nersc-8-procurement/trinity-nersc-8-rfp/nersc-8-trinity-benchmarks/minighost/][ref]] | unknown | MPI | Gfortran | need some adjustments |
| [[http://www.nersc.gov/assets/Trinity--NERSC-8-RFP/Benchmarks/July12/osu-micro-benchmarks-3.8-July12.tar][OMB_MPI Tests]] | [[http://www.nersc.gov/users/computational-systems/cori/nersc-8-procurement/trinity-nersc-8-rfp/nersc-8-trinity-benchmarks/omb-mpi-tests/][ref]] | unknown | MPI | C | MPI work |
| [[http://www.nersc.gov/assets/Trinity--NERSC-8-RFP/Benchmarks/Jan9/smb1.0-1.tar][SMB]] | [[http://www.nersc.gov/users/computational-systems/cori/nersc-8-procurement/trinity-nersc-8-rfp/nersc-8-trinity-benchmarks/smb/][ref]] | unknown | MPI | C | work well |
| [[http://www.nersc.gov/assets/Trinity--NERSC-8-RFP/Benchmarks/June28/psnap-1.2June28.tar][psnap]] | [[http://www.nersc.gov/users/computational-systems/cori/nersc-8-procurement/trinity-nersc-8-rfp/nersc-8-trinity-benchmarks/psnap/][ref]] | unknown | MPI | C | work well |
| [[http://www.nersc.gov/users/computational-systems/cori/nersc-8-procurement/trinity-nersc-8-rfp/nersc-8-trinity-benchmarks/ziatest/][ziatest]] | [[http://www.nersc.gov/users/computational-systems/cori/nersc-8-procurement/trinity-nersc-8-rfp/nersc-8-trinity-benchmarks/ziatest/][ref]] | unknown | MPI | C | work well |
| [[http://www.nersc.gov/assets/Trinity--NERSC-8-RFP/Benchmarks/Mar29/mdtest-1.8.4.tar][mdtest]] | [[http://www.nersc.gov/users/computational-systems/cori/nersc-8-procurement/trinity-nersc-8-rfp/nersc-8-trinity-benchmarks/mdtest/][ref]] | unknown | MPI | C | work well |
| [[http://www.nersc.gov/assets/Trinity--NERSC-8-RFP/Benchmarks/July5/mpimemu-1.0-rc6July5.tar][mpimemu]] | [[http://www.nersc.gov/users/computational-systems/cori/nersc-8-procurement/trinity-nersc-8-rfp/nersc-8-trinity-benchmarks/mpimemu/][ref]] | unknown | MPI | C | work well |

* Notes about [[https://mantevo.org/download/][mantevo]] benchmak codes : 
| Benchmark   | reference |Lines of code | parallelism  | Language | Notes     |
|-------------+---------------+--------------+----------+----------+-----------|
| [[http://mantevo.org/downloads/miniSMAC2D_2.0.html][MiniSMAC2D]] | NONE | unknown | MPI, OPENMP | FORTRAN | Some adjustment should be done to get build the code, although the code show errors and warnings |
| [[http://mantevo.org/downloads/miniXyce_1.0.html][MiniXcye]] | NONE | unknown | MPI | C++ | Work but shows warnings |