...
- install jenkins [[https://wiki.jenkins.io/display/JENKINS/Installing+Jenkins+on+Ubuntu][:book:]]. The passework is reachable through "sudo vi .jenkins/secrets/initialAdminPassword".
